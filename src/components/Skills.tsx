    ...
    <section id="software" className="relative py-24 px-4 md:px-8 max-w-7xl mx-auto">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col items-start text-left mb-4">
          <span className="text-xs font-mono text-blue-500 dark:text-blue-400 font-bold uppercase tracking-widest mb-2">// TOOLBOX</span>
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-slate-900 dark:text-white">Software I Use</h2>
          <div className="mt-4 h-1 w-16 bg-blue-500 rounded-full" />
        </div>

        {/* Premium Interactive Skills Orbit Showcase */}
        <div className="relative">
          <SkillsOrbit darkMode={darkMode} />
        </div>
      </div>
    </section>
  );
